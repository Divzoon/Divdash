          ...
          <div className=" mt-14 mb-1 mx-2 w-full">
            ...
            <div>
              ...
              >
                ...
                <h1
                  className={`${
                    parseInt(props.NextPayment) > parseInt(props.CurrentBalance)
                      ? "text-red-400"
                      : "text-green-400"
                  }${" text-lg font-medium	"}`}
                >
              ...
              <div className="justify-center flex  mx-auto">
                <h1 className="text-sm hover:underline duration-500 active:scale-95 select-none cursor-pointer			uppercase font-thin		">
                  {" "}
                  {trans.LearnMore}
                </h1>{" "}
              </div>
