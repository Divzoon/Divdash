    ...
    <div style={{ fontFamily: "SfproText ,Poppins-Bold", width: "400" }}>
      <Link href={"/"} passHref>
        <div className="mt-12 text-gray-200 select-none active:scale-95 duration-300 ">
          <div
            className={`${pid === "/" ? currentpageColor : null} ${
              locale === "en" ? "flex  " : "flex flex-row-reverse "
            }${"m-1 hover:opacity-50   gap-2  justify-center duration-500 cursor-pointer hover:dark:bg-[#11151d]/60 hover:bg-[#111a24] backdrop-blur-md mx-3 p-1 rounded-lg "}`}
          >
      ...
      <Link href={"/projects"} passHref>
        <div className=" select-none text-gray-200 active:scale-95 duration-300 ">
          <div
            className={`${pid === "/projects" ? currentpageColor : null} ${
              locale === "en" ? "flex  " : "flex flex-row-reverse "
            }${"m-1 hover:opacity-50   gap-2  justify-center duration-500 cursor-pointer hover:dark:bg-[#11151d]/60 hover:bg-[#111a24] backdrop-blur-md mx-3 p-1 rounded-lg "}`}
          >
      ...
      <Link href={"/divchat"} passHref>
        <div className=" select-none  text-gray-200 active:scale-95 duration-300 ">
          <div
            className={`${pid === "/divchat" ? currentpageColor : null} ${
              locale === "en" ? "flex  " : "flex flex-row-reverse "
            }${"m-1 hover:opacity-50   gap-2  justify-center duration-500 cursor-pointer hover:dark:bg-[#11151d]/60 hover:bg-[#111a24] backdrop-blur-md mx-3 p-1 rounded-lg "}`}
          >
      ...
      <Link href={"/settings"} passHref>
        <div className=" select-none text-gray-200 active:scale-95 duration-300 ">
          <div
            className={`${pid === "/settings" ? currentpageColor : null} ${
              locale === "en" ? "flex  " : "flex flex-row-reverse "
            }${"m-1 hover:opacity-50   gap-2  justify-center duration-500 cursor-pointer hover:dark:bg-[#11151d]/60 hover:bg-[#111a24] backdrop-blur-md mx-3 p-1 rounded-lg "}`}
          >
            <div className=" relative mt-[6px] h-5 w-5">
      ...
      <Link href={"/help"} passHref>
        <div className=" select-none text-gray-200 active:scale-95 duration-300 ">
          <div
            className={` ${pid === "/help" ? currentpageColor : null} ${
              locale === "en" ? "flex  " : "flex flex-row-reverse "
            }${"m-1 hover:opacity-50   gap-2  justify-center duration-500 cursor-pointer hover:dark:bg-[#11151d]/60 hover:bg-[#111a24] backdrop-blur-md mx-3 p-1 rounded-lg "}`}
          >
            <div className=" relative mt-[6px] h-5 w-5">
