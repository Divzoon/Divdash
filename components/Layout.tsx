    ...
    <div>
      <header>
        <div
          ...
          className={
            "   active z-50  justify-center  backdrop-blur-sm    dark:bg-[#040506] bg-[#0d151d] fixed   w-full "
          }
        >
                  ...
                  <div className="lg:flex mt-1  gap-3 hidden ">
                    ...
                    <button className=" hover:text-white box-decoration-slice shadow-md hover:shadow-red-500/40    focus:outline-none focus:ring-1 focus:ring-slate-400 focus:ring-offset-2 active:scale-95 duration-300 focus:ring-offset-slate-800  font-bold h-8  px-6 rounded-lg w-full flex items-center text-gray-900 justify-center sm:w-auto bg-gray-200  hover:bg-red-400">
                      <Link href={props.HerfDash} passHref>
                        <h4
                          className={`${
                            locale == "ar" ? "textStyleAr" : ""
                          }${" m-auto font-bold text-gray-900 select-none  text-sm duration-300 hover:text-white"}`}
                        >
                          {props.HomeBtn}{" "}
                        </h4>
                      </Link>
                  ...
                  {transMenu ? (
                    <div className=" mt-4 hidden lg:inline-block justify-start bg-gray-800/40 w-24 rounded-sm  py-1 h-18">
                      ...
                      <Link href={pid} passHref locale="en">
                        <div
                          onClick={() => {
                            router.push(pureRoute, pureRoute, { locale: "en" });
                          }}
                          className="flex justify-around px-2 pt-1 opacity-60 hover:opacity-100 select-none duration-500 cursor:pointer align-middle  gap-1 bg-gray-700 mx-1  rounded-sm"
                        >
                          <div>
                            <Image
                              className=""
...
{props.children}
      <div className=" bg-red-500 mt-28 w-full z-50  absolute bottom-0">
        {" "}
        <Footer footerTrans={locale} />
      </div>
    </div>
  );
}
