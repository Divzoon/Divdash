...
useEffect(() => {
  ...
  return (
   ...
   <button id="theme-toggle" type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-700 dark:hover:bg-gray-900 focus:outline-none focus:ring-0  rounded-full m-1 duration-300 text-sm p-2.5">
