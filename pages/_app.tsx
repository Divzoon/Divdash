...
return (
    <div className={`${"dark:bg-[#080a0e] bg-[#0d151d]"}`}>
   <Head>
...
<div className="">
  ...
  <Component {...pageProps} />
  <footer className=' absolute bottom-0 w-full bg-slate-800 dark:bg-[#080a0e] font-sans font-semibold duration-500 hover:text-red-500 justify-center text-center h-12 pt-2 text-gray-300'>
      <a
