...
function AuthPage() {
  ...
  return (
    <div className=" dark:bg-[#0b0e11] bg-[#0b1121]  h-screen   pb-12">
      <div>
        <header className="  grid grid-cols-3 z-120   opacity-1 dark:bg-[#040506] bg-[#0d151d] backdrop-blur-md sticky top-0 h-[50px]  items-center font-semibold uppercase">
        <div className=" pt-1  flex justify-center mx-auto select-none cursor-pointer ">
                <DarkMode />
              </div>
          <div className="hover:opacity-75 flex justify-center mx-auto cursor-pointer select-none duration-300 px-4 rounded-xl pb-1">
            <Image src="/ico/1.png" alt="Divzoon" height="26" width="118" />
          </div>
<div>s</div>
        </header>
      </div>
            ...
            <div className="grid lg:grid-cols-2 mt-3   items-center justify-center">
              ...
              <div>
                ...
                >
                  <h4
                    style={{
                      fontFamily: "Poppins-Bold , SfproText",
                      width: "400",
                    }}
                  ...
                  >
                    <div className="w-full">
                      <p
                        ...
                        className={`${
                          locale === "en" ?"text-left":"text-right"}${" ml-1 my-1"}`}
                      >
                        {trans.BusinessName}
                      </p>
                      <input
                    ...
                    <div className="w-full">
                      <p
                        ...
                        className={`${
                          locale === "en" ?"text-left":"text-right"}${" relative ml-1 my-1"}`}
                      >
                        {trans.Pass}
                      </p>
                      <div className="relative">
                        ...
                        <div
                          ...
                          className={`${"h-5 w-5  cursor-pointer absolute top-3 mx-2"} ${
                            locale === "ar" ?"text-left left-1":"text-right right-1"}`}
                        >
                          <Image
                            src={`${"/ico/eye/"}${
                              seePass ? "open.png" : "close.png"
                            }`}
                            layout="fill"
                            priority
                          />
                    ...
                    <div className="text-gray-50">
                      <Checkbox defaultSelected={true}>
                        <p
                          className="text-gray-50 text-sm mt-4"
                          style={{
                            fontFamily: "Poppins-Bold , SfproText",
                            width: "400",
                          }}
                        >
                          I want to receive news, feature updates, discounts,
                          and offers from Termly.
                        </p>
                      </Checkbox>
                      <p
                      ...
                      >
                        By signing up, I agree to Divzoon's{" "}
                        <span className="hover:opacity-75 cursor-pointer duration-300 text-red-400">
                          {" "}
